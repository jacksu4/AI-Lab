...
2. **Alpha Seeker** - AI驱动的股票分析工具
   - 支持任意股票代码输入
   - Gemini AI 生成情绪分析、财报摘录、多空分析
   - 终端风格的赛博朋克界面
...
1. 点击首页的 "Alpha Seeker" 卡片
2. 在搜索框输入股票代码 (如: AAPL, NVDA, TSLA) 或点击快捷按钮
3. 观看终端风格的加载动画
4. 等待 Gemini AI 生成分析 (~5-8秒)
5. 查看完整分析:
   - 股价与涨跌幅
   - 情绪评分仪表盘 (0-100)
   - 关键词提取
   - AI生成的财报电话会议摘录
   - 多空分析观点
6. 点击 "NEW SEARCH" 搜索其他股票

> **注意**: Alpha Seeker 的所有数据为 AI 模拟生成,仅供教育用途,不构成投资建议。
